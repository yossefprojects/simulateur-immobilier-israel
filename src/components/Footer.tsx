    ...
    <footer style={{ background: '#0E1B2A' }}>
      ...
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)] gap-10 md:gap-12 px-6 sm:px-10 pt-12 pb-7">
        ...
        <div>
          ...
          >
            <svg viewBox="0 0 56 56" className="h-4 w-4 shrink-0 nc-logo" aria-hidden="true"><rect width="56" height="56" rx="14" fill="#F7F5F0" /><rect className="nc-tower" x="9" y="11" width="19" height="38" rx="3" fill="#0E1B2A" /><rect className="nc-tower nc-tower-2" x="27" y="20" width="19" height="29" rx="3" fill="#0F7B6C" /></svg> NadlanConnect →
          </a>
        </div>
      </div>
